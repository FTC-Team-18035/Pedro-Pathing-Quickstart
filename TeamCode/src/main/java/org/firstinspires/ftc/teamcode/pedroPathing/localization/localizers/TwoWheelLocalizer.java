...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES =  -.0005; //8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES =   -.0005; //8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-3.25, -7.4375, 0);
        strafeEncoderPose = new Pose(-6.3125, -.25, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Fleft"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Fright"));
